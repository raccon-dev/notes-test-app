                ...
                <ul className="notes-list">
                    ...
                    <li className="notes-item">
                        ...
                        <div className="notes-buttons-wrapper">
                            <button className="btn-removeNotes">
                            ...
                            <button className="btn btn-editNote">
                        ...
                        <textarea readOnly className="notes-body notes-edit-section" name="" id="" cols="25"
                            rows="7"> Lorem ipsum dolor si elit. Ipsam libero est boluptatibus fugiat ratione! Et   necessitatibus necessitatibusnecessitatibusrum! </textarea>
                        <div className="notes-footer">
                            <p className="date"> <span className="edited-props">last edited</span> May 21 09 2020</p>
